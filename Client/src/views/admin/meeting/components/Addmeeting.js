...
const AddMeeting = (props) => {
  const { onClose, isOpen, setAction, leadContect, id } = props;
              ...
              <GridItem colSpan={{ base: 12 }}>
                <Flex alignItems={'end'} justifyContent={'space-between'}>
                    ...
                    <CUIAutoComplete
                      ...
                      selectedItems={countriesWithEmailAsLabel?.filter((item) =>
                        values.related === "Contact"
                          ...
                          : values.related === "Lead" && values?.attendesLead.includes(item._id)
                      )}
                  ...
                  <IconButton
                    mb={6}
                    onClick={() =>
                      values.related === "Contact" ? setContactModel(true) : setLeadModel(true)
                    }
                    fontSize='25px'
